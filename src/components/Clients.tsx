...
export default function Clients() {
  return (
    <div>
      <section className="w-full py-12 bg-slate-200 rounded-lg  md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center  justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold text-slate-950 tracking-tighter sm:text-5xl md:text-6xl">
                Client Transformations
              </h1>
              <p className="max-w-[700px] text-slate-700 md:text-xl dark:text-gray-400">
      ...
      >
        <div className="container grid grid-cols-1 gap-6 px-4 md:grid-cols-2 lg:grid-cols-3 md:px-6">
          <div className="overflow-hidden rounded-lg bg-slate-200 shadow-sm transition-all hover:scale-[1.02] hover:shadow-md dark:bg-gray-950 dark:hover:shadow-lg">
            ...
            <div className="p-4">
              <h3 className="text-xl text-slate-950 font-bold">John Doe</h3>
